...
class inscription
{
    ...
    public function insertInto()
    {
        ...
        if (isset($this->surname) && isset($this->name) && isset($this->naissance) && isset($this->sexe)
            && isset($this->ville) && isset($this->mail) && isset($this->password)) {
            if ($this->surname != null && $this->name != null && $this->naissance != null && $this->sexe != null
                ...
                if ($verification == null) {
                    ...
                    $sql->execute(array($this->surname, $this->name, $this->naissance, $this->sexe, $this->ville,
                    ...
                    if ($majeur >= 18) {
                        ...
                        $requet_sql_on->closeCursor();
                         echo "Inscription réussis avec succés. <a href=\"../index.php\">SE CONNECTER</a><br/>";
                    } elseif ($majeur < 18) {
